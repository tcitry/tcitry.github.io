...
async function fixture(t) {
  ...
  const release = { version: 1, environment: 'production', ...inputs, contentCommit: corpus.manifest.revision.contentCommit, assets: await assetHashes(path.join(root, 'dist')) };
