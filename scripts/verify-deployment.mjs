...
async function main() {
  ...
  const selected = new Set(['/', '/archives/', '/modified/', '/posts/', '/weekly/', '/timeline/', '/portfolio/', '/links/', '/tags/', '/categories/', '/about/', '/docs/', '/lab/', '/lab/agent-replay/', '/demos/2026/rounded-timeline/']);
  ...
  const lab = results.get('/lab/').body;
